...
set_property -dict { PACKAGE_PIN R2    IOSTANDARD SSTL135 } [get_ports { clk_100 }]; #IO_L12P_T1_MRCC_34 Sch=ddr3_clk[200]
create_clock -add -name sys_clk_pin -period 10.000 -waveform {0 5.000}  [get_ports { clk_100 }];
...
set_property -dict { PACKAGE_PIN V14   IOSTANDARD LVCMOS33 } [get_ports { vsync_out }]; #IO_L20P_T3_A08_D24_14        Sch=jc10/ck_io[34]
set_property -dict { PACKAGE_PIN R13   IOSTANDARD LVCMOS33 } [get_ports { hsync_out }]; #IO_L19N_T3_A09_D25_VREF_14   Sch=jc9/ck_io[35]
set_property -dict { PACKAGE_PIN P13   IOSTANDARD LVCMOS33 } [get_ports { clk_25 }]; #IO_L19P_T3_A10_D26_14        Sch=jc8/ck_io[36]
...
set_property -dict { PACKAGE_PIN U17   IOSTANDARD LVCMOS33 } [get_ports { pixel[2] }]; #IO_L15P_T2_DQS_RDWR_B_14     Sch=jc3/ck_io[39]
set_property -dict { PACKAGE_PIN V16   IOSTANDARD LVCMOS33 } [get_ports { pixel[1] }]; #IO_L18N_T2_A11_D27_14        Sch=jc2/ck_io[40]
set_property -dict { PACKAGE_PIN U15   IOSTANDARD LVCMOS33 } [get_ports { pixel[0] }]; #IO_L18P_T2_A12_D28_14        Sch=jc1/ck_io[41]
